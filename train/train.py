...
def train(attributes):
	...
	attributes = {'structure': architecture of the model
                      ...
                      'uncertainty':0.05 for Case 2.X and 0.1 for Case 1.X
                      }
	"""
	if attributes['structure'] == 'kernel_3':
		if attributes['Dropout'] == True:
			from models.kernel_3 import NNDC_dropout as NNDC
			from models.kernel_3 import NNDC as NNDC_
		else:
	    ...
	    if attributes['Dropout'] == True:
			from models.nearest import NNDC_dropout as NNDC
			from models.nearest import NNDC as NNDC_
		else:
		...
		if attributes['Dropout'] == True:
			from models.convtranspose import NNDC_dropout as NNDC
			from models.convranspose import NNDC as NNDC_
		else:
